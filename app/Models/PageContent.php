 ...
 * @method static PageContent|null first()
 * @method static \Illuminate\Database\Eloquent\Collection<int, PageContent> get()
 * @method static PageContent create(array $attributes = [])
 * @method static PageContent firstOrCreate(array $attributes = [], array $values = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|PageContent where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder<static>|PageContent whereNotNull(string|\Illuminate\Contracts\Database\Query\Expression $columns)
