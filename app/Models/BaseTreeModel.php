 ...
 * @method static BaseTreeModel|null first()
 * @method static \Illuminate\Database\Eloquent\Collection<int, BaseTreeModel> get()
 * @method static BaseTreeModel create(array $attributes = [])
 * @method static BaseTreeModel firstOrCreate(array $attributes = [], array $values = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|BaseTreeModel where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder<static>|BaseTreeModel whereNotNull(string|\Illuminate\Contracts\Database\Query\Expression $columns)
