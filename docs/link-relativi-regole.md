...
```markdown
[Link errato](/var/www/html/_bases/base_saluteora/docs/file.md)
...
Logica: 
  ...
  laravel/ → ../ (torna a base_saluteora/)
  base_saluteora/ → docs/ (entra nella root docs)
```
...
```markdown
<!-- PRIMA (ERRATO) -->
[Modulo User](/var/www/html/_bases/base_saluteora/laravel/Modules/User/docs/README.md)
