...
```json
{
    ...
    "description": "Tema per <nome progetto>",
    "type": "theme",
    "license": "proprietary",
    "autoload": {
        "psr-4": {
            "<nome progetto>\\Themes\\ThemeName\\": "src/"
        }
    },
    "extra": {
        "laravel": {
            "providers": [
                "<nome progetto>\\Themes\\ThemeName\\ThemeServiceProvider"
            ]
        }
    },
    "require": {
...
namespace <nome progetto>\Themes\ThemeName;
