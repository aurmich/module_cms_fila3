...
# Controllo 3: Progetti vecchi base_techplanner
echo -e "\n❌ Cercando riferimenti progetti vecchi..."
OLD_PROJECTS=$(grep -r "base_techplanner" Modules/*/docs/ --include="*.md" | wc -l)
if [ $OLD_PROJECTS -gt 0 ]; then
    echo "🚨 ERRORE: Trovati $OLD_PROJECTS riferimenti a progetti vecchi!"
    grep -r "base_techplanner" Modules/*/docs/ --include="*.md"
else
