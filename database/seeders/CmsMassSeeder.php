...
class CmsMassSeeder extends Seeder
{
    ...
    private function createCmsModules(): void
    {
        ...
        $this->command->info('✅ Creati '.$modules->count()/** @phpstan-ignore method.nonObject */.' moduli CMS');
    }
    ...
    private function createSections(): void
    {
        ...
        $this->command->info('✅ Create '.$sections->count()/** @phpstan-ignore method.nonObject */.' sezioni');
    }
    ...
    private function createPages(): void
    {
        ...
        $this->command->info('✅ Create '.$pages->count()/** @phpstan-ignore method.nonObject */.' pagine');
    }
    ...
    private function createPageContents(): void
    {
        ...
        $this->command->info('✅ Creati '.$contents->count()/** @phpstan-ignore method.nonObject */.' contenuti di pagina');
    }
    ...
    private function createMenus(): void
    {
        ...
        $this->command->info('✅ Creati '.$menus->count()/** @phpstan-ignore method.nonObject */.' menu');
    }
    ...
    private function createConfigurations(): void
    {
        ...
        $this->command->info('✅ Caricati '.$configs->count()/** @phpstan-ignore method.nonObject */.' configurazioni da Sushi');
    }
