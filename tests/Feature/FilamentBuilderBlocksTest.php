...
=======
        expect($allBlocks->count()/** @phpstan-ignore method.nonObject */)->toBeGreaterThan(0, 'At least one block should be discovered');
...
<<<<<<< HEAD
        ...
        expect($cmsBlocks->count()/** @phpstan-ignore method.nonObject */)->toBeGreaterThan(0, 'CMS module should have blocks');
