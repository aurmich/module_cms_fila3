...
- [EMAIL_LAYOUTS_BEST_PRACTICES.md](/laravel/Modules/Notify/docs/mail-templates/EMAIL_LAYOUTS_BEST_PRACTICES.md)
- [SPATIE_MAIL_TEMPLATES_STRUCTURE.md](/laravel/Modules/Notify/docs/mail-templates/SPATIE_MAIL_TEMPLATES_STRUCTURE.md)

### Copie di Questa Documentazione
- [.windsurf/rules/email-templates-structure.md](/laravel/.windsurf/rules/email-templates-structure.md)
- [.cursor/rules/email-templates-structure.md](/laravel/.cursor/rules/email-templates-structure.md)
