...
class MassiveDataSeeder extends Seeder
{
    ...
    private function seedHealthcareData(): void
    {
        ...
        if (class_exists(\Modules\SaluteMo\Database\Seeders\PatientSeeder::class)) {
    ...
    private function printStatistics(): void
    {
        ...
        $stats = [
            ...
            'SaluteMo Patients' => class_exists(\Modules\SaluteMo\Models\Patient::class) ? \Modules\SaluteMo\Models\Patient::count() : 0,
        ];
