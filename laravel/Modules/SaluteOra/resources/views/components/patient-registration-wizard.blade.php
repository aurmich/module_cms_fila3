        ...
        <div class="wizard-step {{ $currentStep == 1 ? 'block' : 'hidden' }}">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="form-group">
                    ...
                    <input type="text" name="first_name" id="first_name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" value="{{ $patientData['first_name'] ?? old('first_name') }}" required>
                    @error('first_name')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="last_name" id="last_name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" value="{{ $patientData['last_name'] ?? old('last_name') }}" required>
                    @error('last_name')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                    ...
                    <div>
                        ...
                        <dl class="mt-2 space-y-1">
                            <div class="flex justify-between">
                                ...
                                <dd class="text-sm text-gray-900">{{ $patientData['first_name'] ?? '' }}</dd>
                            </div>
                            <div class="flex justify-between">
                                <dt class="text-sm text-gray-500">Cognome:</dt>
                                <dd class="text-sm text-gray-900">{{ $patientData['last_name'] ?? '' }}</dd>
                            </div>
                            <div class="flex justify-between">
...
<script type="text/javascript">
    ...
    function nextStep() {
        ...
        // Validazione step 1
        if (currentStep === 1) {
            var requiredFields = ['first_name', 'last_name', 'fiscal_code', 'birth_date', 'gender'];
