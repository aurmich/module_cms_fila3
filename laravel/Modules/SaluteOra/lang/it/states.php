...
return [
    ...
    // Doctor States - Stati Dentista
    'doctor' => [
        'pending' => [
            'label' => 'In attesa',
            'description' => 'Dentista in attesa di approvazione',
            'tooltip' => 'Il dentista è in attesa di essere approvato',
            'modal_heading' => 'Approvazione Dentista',
            'modal_description' => 'Conferma l\'approvazione di questo dentista per l\'accesso al sistema',
            'color' => 'warning',
            'bg_color' => '#f59e0b',
            'icon' => 'heroicon-o-clock',
        ],
        'active' => [
            'label' => 'Attivo',
            'description' => 'Dentista attivo nel sistema',
            'tooltip' => 'Il dentista è attivo e può ricevere appuntamenti',
            'modal_heading' => 'Attiva Dentista',
            'modal_description' => 'Sei sicuro di voler attivare questo dentista? Il dentista potrà ricevere appuntamenti.',
            'color' => 'success',
            'bg_color' => '#10b981',
            'icon' => 'heroicon-o-check-circle',
        ],
        'inactive' => [
            'label' => 'Non attivo',
            'description' => 'Dentista non attivo nel sistema',
            'tooltip' => 'Il dentista è stato disattivato',
            'modal_heading' => 'Disattiva Dentista',
            'modal_description' => 'Sei sicuro di voler disattivare questo dentista? Il dentista non potrà più ricevere appuntamenti.',
            'color' => 'gray',
            'bg_color' => '#6b7280',
            'icon' => 'heroicon-o-x-circle',
        ],
        'rejected' => [
            'label' => 'Rifiutato',
            'description' => 'Dentista rifiutato',
            'tooltip' => 'Il dentista è stato rifiutato',
            'modal_heading' => 'Rifiuta Dentista',
            'modal_description' => 'Conferma il rifiuto di questo dentista. Specifica il motivo del rifiuto',
            'color' => 'danger',
            'bg_color' => '#ef4444',
            'icon' => 'heroicon-o-x-mark',
        ],
        'suspended' => [
            'label' => 'Sospeso',
            'description' => 'Dentista sospeso',
            'tooltip' => 'Il dentista è stato sospeso',
            'modal_heading' => 'Sospendi Dentista',
            'modal_description' => 'Conferma la sospensione temporanea di questo dentista dal sistema',
            'color' => 'danger',
            'bg_color' => '#dc2626',
            'icon' => 'heroicon-o-pause',
        ],
        'integration_requested' => [
            'label' => 'Integrazione richiesta',
            'description' => 'Richiesta di integrazione in corso',
            'tooltip' => 'Il dentista ha richiesto l\'integrazione',
            'modal_heading' => 'Richiesta Integrazione Dentista',
            'modal_description' => 'Questo dentista ha richiesto l\'integrazione con il sistema sanitario nazionale.',
            'color' => 'info',
            'bg_color' => '#3b82f6',
            'icon' => 'heroicon-o-document-plus',
        ],
        'integration_completed' => [
            'label' => 'Integrazione completata',
            'description' => 'Integrazione completata con successo',
            'tooltip' => 'Il dentista ha completato l\'integrazione',
            'modal_heading' => 'Integrazione Dentista Completata',
            'modal_description' => 'L\'integrazione di questo dentista è stata completata con successo.',
            'color' => 'success',
            'bg_color' => '#10b981',
            'icon' => 'heroicon-o-check-badge',
        ],
