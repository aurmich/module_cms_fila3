...
return [
    ...
    'steps' => [
        ...
        'privacy_step' => [
            ...
            'icon' => 'heroicon-o-shield-check',
            'color' => 'info',
            'tooltip' => 'Privacy consent and marketing management',
            'helper_text' => 'Privacy consent is required by law, newsletter is optional',
        ],
        'availability_step' => [
            'label' => 'Availability',
            'description' => 'Manage hours and days of availability',
            'icon' => 'heroicon-o-calendar',
            'color' => 'emerald',
            'tooltip' => 'Configuration of availability hours and days',
            'helper_text' => '',
        ],
    ],
    'fields' => [
        ...
        'first_name' => [
            ...
            'tooltip' => 'First name as registered with the Medical Board',
            'helper_text' => '',
        ...
        'last_name' => [
            ...
            'tooltip' => 'Last name as registered with the Medical Board',
            'helper_text' => '',
        ...
        'specialization' => [
            ...
            'tooltip' => 'Primary medical specialization',
            'helper_text' => '',
    ...
    'filters' => [
        ...
        'is_active' => [
            ...
            'helper_text' => '',
            'description' => 'Filter by medical profile status',
            'options' => [
                'active' => 'Active',
                'inactive' => 'Inactive',
                'pending' => 'Pending',
    ...
    'actions' => [
        'create' => [
            ...
            'modal_description' => 'Enter the new doctor\'s data',
        ...
        'edit' => [
            ...
            'color' => 'warning',
            'tooltip' => 'Edit selected doctor\'s data',
            'modal_heading' => 'Edit Doctor',
            'modal_description' => 'Edit doctor\'s data',
