# Widget Implementation Rules - SaluteMo
...
class MyWidget extends XotBaseChartWidget
{
    ...
    protected function getData(): array
    {
        $cacheKey = 'salutemo:dashboard:widget:widget_name';
        ...
        return Cache::remember($cacheKey, 300, function () {
            ...
            return [
                'datasets' => [
                    [
                        'label' => __('salutemo::widgets.widget_name.label'),
                        'data' => $data,
...
grep -r "protected function getHeading" laravel/Modules/SaluteMo/app/Filament/Widgets/

# Controllo strict types
grep -L "declare(strict_types=1);" laravel/Modules/SaluteMo/app/Filament/Widgets/*.php
```
...
- **Cache Keys**: `salutemo:dashboard:widget:{widget_name}`
