...
return [
    ...
    'validation' => [
        ...
        'name_min' => 'Der Name muss mindestens 3 Zeichen enthalten',
        ...
        'phone_format' => 'Die Telefonnummer muss ein gültiges Format haben',
        'address_required' => 'Die Adresse ist erforderlich',
        'registration_number_unique' => 'Diese Registrierungsnummer wird bereits verwendet',
        'vat_number_format' => 'Die Umsatzsteuer-Identifikationsnummer muss ein gültiges Format haben',
    ],
    'notifications' => [
        'studio_created' => [
