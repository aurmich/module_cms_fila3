...
class PageManagementBusinessLogicTest extends TestCase
{
    ...
    public function it_can_create_page_with_basic_information(): void
    {
        ...
        $pageData = [
            ...
            'slug' => 'home',
            'status' => 'published',
            'meta_title' => 'Home Page - SaluteOra',
            'meta_description' => 'Pagina principale di SaluteOra',
        ];
    ...
    public function it_can_create_page_with_content(): void
    {
        ...
        $contentData = [
            'page_id' => $page->id,
            'content' => '<h1>Benvenuti su SaluteOra</h1><p>La vostra salute è la nostra priorità.</p>',
            'locale' => 'it',
            'version' => 1,
        ];
    ...
    public function it_can_update_page_seo_metadata(): void
    {
        ...
        $seoData = [
            ...
            'canonical_url' => 'https://saluteora.com/pagina',
        ];
    ...
    public function it_can_manage_page_redirects(): void
    {
        ...
        $redirectData = [
            'redirect_type' => '301',
            'redirect_url' => 'https://saluteora.com/nuova-pagina',
