                ...
                <div class="w-full lg:w-2/4 bg-white rounded-lg shadow-2xl">
                    <div class="p-5">
                        ...
                        <div class="flex flex-row items-center">
                            ...
                            <x-filament::badge
                                color="{{ $appointment->state->color() }}">{{ $appointment->state->label() }}</x-filament::badge>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full flex justify-center">
                <div class="flex flex-col justify-center">
                    <h3 class="text-[#FF5F7E]">
                        @lang('pub_theme::report.ready_title')
                    </h3>
                    ...
                    <div class="relative w-64 h-48 mt-5 rounded-[25px] bg-[#E6EBF7] shadow-2xl overflow-hidden">
                        ...
                        <button wire:click="downloadReport"
                            class="flex items-center justify-between absolute bottom-0 left-0 w-full bg-[#E6EBF7B3] text-[#272C4D] px-3 text-center text-xl font-extrabold py-5 transition-all duration-300 ease-in-out hover:py-9"
                            title="@lang('pub_theme::report.download_tooltip')">
                            @lang('pub_theme::report.download_button')
