        ...
        <div class="medical-answer">
            ...
            @if($appointment->report->has_mouth_or_teeth_pain && $appointment->report->mouth_teeth_pain_frequency)
                <div class="detail-box">
                    <span class="detail-label">@lang('pub_theme::appointment.report.labels.frequency'):</span> {{ $appointment->report->mouth_teeth_pain_frequency }}
                </div>
            @endif
        </div>
    </div>
    ...
    <div class="medical-item">
        ...
        <div class="medical-answer">
            @if($appointment->report->pregnancy_month)
                <div><span class="detail-label">@lang('pub_theme::appointment.report.labels.month'):</span> {{ $appointment->report->pregnancy_month }}</div>
            @endif
            @if($appointment->report->pregnancy_week)
                <div><span class="detail-label">@lang('pub_theme::appointment.report.labels.week'):</span> {{ $appointment->report->pregnancy_week }}</div>
            @endif
        </div>
    </div>
    @endif
