...
Questo documento fornisce una guida dettagliata per l'implementazione dell'interfaccia utente del progetto il progetto utilizzando Filament 3.x, con particolare attenzione alla creazione di pannelli separati per i diversi tipi di utenti (amministratori, odontoiatri e pazienti).
