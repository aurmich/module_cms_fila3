...
## Dipendenze Critiche
- **Tailwind CSS**: Per la compatibilità con Filament 3.x, è **obbligatorio** utilizzare `tailwindcss@3.x`. Non aggiornare a versioni superiori finché non sarà supportato ufficialmente da Filament.
