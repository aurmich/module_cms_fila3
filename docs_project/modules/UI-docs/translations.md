# Sistema di Traduzioni - Regole Centralizzate

## Principi Fondamentali

### Struttura Espansa Obbligatoria
Tutte le traduzioni devono utilizzare la struttura espansa con `label`, `placeholder` e `help`:
...
1. **Root Documentation**
   - `docs_project/translation-standards.md` - Standard globali di traduzione
