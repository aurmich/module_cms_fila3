# Audit Traduzioni Campi "Regione", "Provincia", "Accedi" - Documentazione Root
...
- **fields.php**: ✅ CORRETTO - Già tradotto correttamente
- **saluteora.php**: ✅ CORRETTO - Già tradotto correttamente
- **auth.php**: ❌ Testo in italiano: `'login-via' => 'Accedi con'` → deve essere `'Anmelden mit'`
- **auth.php**: ❌ Testo in italiano: `'Sign in to your account' => 'Accedi al tuo account'` → deve essere `'Anmelden bei Ihrem Konto'`

#### File Inglesi con Testo in Italiano
- **fields.php**: ✅ CORRETTO - Già tradotto correttamente
- **auth.php**: ❌ Testo in italiano: `'login-via' => 'Accedi con'` → deve essere `'Sign in with'`
- **auth.php**: ❌ Testo in italiano: `'Sign in to your account' => 'Accedi al tuo account'` → deve essere `'Sign in to your account'`
...
2. `laravel/Modules/User/lang/en/auth.php` - Correzioni testo in italiano

### Priorità Media
1. `laravel/Modules/SaluteOra/lang/de/fields.php` - Aggiungere struttura completa
2. `laravel/Modules/SaluteOra/lang/en/fields.php` - Aggiungere struttura completa
...
- [Audit Traduzioni Campi "Città"](../laravel/Modules/SaluteOra/docs/translation_audit_city_fields.md)
...
- [Documentazione Modulo](../laravel/Modules/SaluteOra/docs/translation_audit_region_province_login.md)
